...
def map_clouds_to_grid_instance(voxel_size, points, instance_ids, values=None, grid_shape=(60, 60, 60), origin=None):
    ...
    for i, uid in enumerate(unique_ids):
        ...
        if values is None:
            grid[tuple(idx.T) + (i,)] = 1.0
        else:
            grid[tuple(idx.T) + (i,)] = values[mask].squeeze()
